...
There are likely gross errors which please point out in the issue tracker. 
...
Running this showed lots of sensitivity around 1/31 to 1/33 infection rate. Thought I should graph it, see below:
...
df = data.frame()
for (i in 20:34) {
  df2 = runModel1(runName = paste(1, "/", i, sep = ""), nPop = 1e+04, 
